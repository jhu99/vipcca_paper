...
data_names = [
    './data/scanorama_data/data/mouse_brain/nuclei',
    './data/scanorama_data/data/mouse_brain/dropviz/Cerebellum_ALT',
    './data/scanorama_data/data/mouse_brain/dropviz/Cortex_noRep5_FRONTALonly',
    './data/scanorama_data/data/mouse_brain/dropviz/Cortex_noRep5_POSTERIORonly',
    './data/scanorama_data/data/mouse_brain/dropviz/EntoPeduncular',
    './data/scanorama_data/data/mouse_brain/dropviz/GlobusPallidus',
    './data/scanorama_data/data/mouse_brain/dropviz/Hippocampus',
    './data/scanorama_data/data/mouse_brain/dropviz/Striatum',
    './data/scanorama_data/data/mouse_brain/dropviz/SubstantiaNigra',
    './data/scanorama_data/data/mouse_brain/dropviz/Thalamus',
]
...
if __name__ == '__main__':
    ...
    #     pickle.dump([datasets_dimred, genes], f)
